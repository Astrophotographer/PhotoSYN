      ...
      <div class="col-lg-12">
        ...
        <div id="imgList">
          <c:forEach items="${blog_imgs}" var="img">
            <img src="${pageContext.request.contextPath}/resources/saveImgckImage/${img.BI_NAME}" width="100px" height="100px">
          </c:forEach>
        </div>
        ...
        <label>
          추가태그 : <input type="text" name="B_TAG1" placeholder="#으로 구분하여 추가해주세요. 예시 #고양이" width="200" value="${blog.b_TAG1}">
        </label>
        <div>
        작성일 : ${blog.b_REG}
        좋아요 : ${blog.b_LIKE}
