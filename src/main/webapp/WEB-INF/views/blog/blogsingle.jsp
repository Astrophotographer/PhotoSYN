...
<div>
    ...
    <table>
        <tr>
            <td>글번호 : ${blog.b_NO}</td>
            <td>제목 : ${blog.b_SUBJECT}</td>
            <td>내용 : ${blog.b_CONTENT}</td>
        </tr>
    </table>
</div>
                ...
                <div class="single-post">
                    <div class="post-header mb-5 text-center">
                        ...
                        <div class="post-featured-image mt-5">
                            <img src="../resources/blog/images/fashion/bg-banner.jpg" class="img-fluid w-100" alt="featured-image">
                        </div>
                    </div>
                    <div class="post-body">
                        <div class="entry-content">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <img src="../resources/blog/images/fashion/single-img1.png" alt="post-ads" class="img-fluid mr-4 w-100">
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <img src="../resources/blog/images/fashion/single-img2.png" alt="post-ads" class="img-fluid mr-4 w-100">
                                </div>
                            </div>
