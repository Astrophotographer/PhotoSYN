        ...
        <div class="upload-box-inner">
            <div class="upload-box-heading c16 center-box">
                <div class="upload-box-status">
                    ...
                    <div data-group="upload-queue-ready" class="soft-hidden" style="display: none;">
                    ...
                    <div data-group="uploading" class="soft-hidden" style="display: none;">
                        ...
                        <div class="heading">Uploading <span data-text="queue-size">0</span> <span
                                data-text="queue-objects">images</span> (<span data-text="queue-progress">0</span>%
                            complete)
                        </div>
                    ...
                    <div data-group="upload-result" data-result="error" class="soft-hidden" style="display: none;">
                        ...
                        <div class="heading">No <span data-text="queue-objects">images</span> have been uploaded</div>
            ...
            <ul id="anywhere-upload-queue" class="upload-box-queue content-width soft-hidden queueEmpty"
                data-group="upload-queue" style="display: none;"></ul>
