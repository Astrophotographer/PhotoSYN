...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="../resources/gallery/shopy/assets/img/favicon.ico">
    <!-- CSS Template -->
    <link href="../resources/gallery/shopy/assets/css/theme.css" rel="stylesheet">
...
<div class="wrapper">
    <!-- Header Height -->
    <div class="header-height-bar" style="min-height: 73.6406px;"></div>
    <main>
        <!-- Home Section -->
        <div class="swiper swiper-container swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden"
             data-swiper-options="{
                  &quot;slidesPerView&quot;: 1,
                  &quot;spaceBetween&quot;: 0,
                  &quot;pagination&quot;: {
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-f2748b84baf33645" aria-live="off"
                 style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                <div class="swiper-slide swiper-slide-active" style="width: 400px;" role="group" aria-label="1 / 2">
                ...
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 2" style="width: 400px;">
                    <div class="bg-cover bg-no-repeat bg-center"
            ...
            <div class="swiper-arrow-style-01 swiper-next swiper-next-01" tabindex="0" role="button"
                 aria-label="Next slide" aria-controls="swiper-wrapper-f2748b84baf33645" aria-disabled="false"><i
                    class="bi bi-chevron-right"></i></div>
            <div class="swiper-arrow-style-01 swiper-prev swiper-prev-01 swiper-button-disabled" tabindex="-1"
                 role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f2748b84baf33645"
                 aria-disabled="true"><i class="bi bi-chevron-left"></i></div>
            ...
            <div class="container">
                ...
                <div class="swiper-hover-arrow position-relative">
                    <div class="swiper swiper-container swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden"
                        ...
                        <div class="swiper-wrapper" id="swiper-wrapper-d9a1b88b27852062" aria-live="off"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                                 style="width: 176px; margin-right: 24px;" role="group" aria-label="5 / 5"
...
<%--                                 style="width: 176px; margin-right: 24px;" role="group" aria-label="1 / 5"--%>
...
<%--                                        <div class="product-media-hover">--%>
<%--                                            <a href="#">--%>
<%--                                                <img src="../resources/gallery/shopy/assets/img/product-1.jpg" title=""--%>
<%--                                                     alt="">--%>
<%--                                                <img class="hover-image"--%>
<%--                                                     src="../resources/gallery/shopy/assets/img/product-1-hover.jpg"--%>
<%--                                                     title="" alt="">--%>
<%--                                            </a>--%>
<%--                                        </div>--%>
<%--                                        <div class="product-action">--%>
...
<%--                            </div>--%>
<%--                            <!-- Product Card -->--%>
<%--                            <div class="swiper-slide" style="width: 176px; margin-right: 24px;" role="group"--%>
<%--                                 aria-label="2 / 5" data-swiper-slide-index="1">--%>
<%--                                <div class="product-card-01 my-1">--%>
<%--                                    <div class="product-media">--%>
<%--                                        <div class="product-media-hover">--%>
<%--                                            <a href="#">--%>
<%--                                                <img src="../resources/gallery/shopy/assets/img/product-2.jpg" title=""--%>
<%--                                                     alt="">--%>
<%--                                                <img class="hover-image"--%>
<%--                                                     src="../resources/gallery/shopy/assets/img/product-2-hover.jpg"--%>
<%--                                                     title="" alt="">--%>
<%--                                            </a>--%>
<%--                                        </div>--%>
<%--                                        <div class="product-action">--%>
...
<%--                                        <div class="product-media-hover">--%>
<%--                                            <a href="#">--%>
<%--                                                <img src="../resources/gallery/shopy/assets/img/product-3.jpg" title=""--%>
<%--                                                     alt="">--%>
<%--                                                <img class="hover-image"--%>
<%--                                                     src="../resources/gallery/shopy/assets/img/product-3-hover.jpg"--%>
<%--                                                     title="" alt="">--%>
<%--                                            </a>--%>
<%--                                        </div>--%>
<%--                                        <div class="product-action">--%>
...
<%--                            </div>--%>
<%--                            <!-- Product Card -->--%>
<%--                            <div class="swiper-slide swiper-slide-prev" style="width: 176px; margin-right: 24px;"--%>
<%--                                 role="group" aria-label="4 / 5" data-swiper-slide-index="3">--%>
<%--                                <div class="product-card-01 my-1">--%>
<%--                                    <div class="product-media">--%>
<%--                                        <div class="product-media-hover">--%>
<%--                                            <a href="#">--%>
<%--                                                <img src="../resources/gallery/shopy/assets/img/product-4.jpg" title=""--%>
<%--                                                     alt="">--%>
<%--                                                <img class="hover-image"--%>
<%--                                                     src="../resources/gallery/shopy/assets/img/product-4-hover.jpg"--%>
<%--                                                     title="" alt="">--%>
<%--                                            </a>--%>
<%--                                        </div>--%>
<%--                                        <div class="product-action">--%>
...
<%--                            </div>--%>
<%--                            <!-- Product Card -->--%>
<%--                            <div class="swiper-slide swiper-slide-active" style="width: 176px; margin-right: 24px;"--%>
<%--                                 role="group" aria-label="5 / 5" data-swiper-slide-index="4">--%>
<%--                                <div class="product-card-01 my-1">--%>
<%--                                    <div class="product-media">--%>
<%--                                        <div class="product-lable">--%>
<%--                                            <span class="bg-danger text-white">Hot</span>--%>
...
<%--                                        <div class="product-media-hover">--%>
<%--                                            <a href="#">--%>
<%--                                                <img src="../resources/gallery/shopy/assets/img/product-5.jpg" title=""--%>
<%--                                                     alt="">--%>
<%--                                                <img class="hover-image"--%>
<%--                                                     src="../resources/gallery/shopy/assets/img/product-5-hover.jpg"--%>
<%--                                                     title="" alt="">--%>
<%--                                            </a>--%>
<%--                                        </div>--%>
<%--                                        <div class="product-action">--%>
...
<%--                                </div>--%>
<%--                            </div>--%>
<%--                            <div class="swiper-slide swiper-slide-duplicate" style="width: 176px; margin-right: 24px;"--%>
...
<%--                            </div>--%>
                        ...
                        <div class="swiper-pagination mt-4 d-lg-none position-relative swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                            <span class="swiper-pagination-bullet" tabindex="0" role="button"
                                ...
                                role="button" aria-label="Go to slide 5" aria-current="true"></span></div>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                    <div class="swiper-arrow-style-02 swiper-next swiper-next-02" tabindex="0" role="button"
                         aria-label="Next slide" aria-controls="swiper-wrapper-d9a1b88b27852062"><i
                            class="bi bi-chevron-right"></i></div>
                    <div class="swiper-arrow-style-02 swiper-prev swiper-prev-02" tabindex="0" role="button"
                         aria-label="Previous slide" aria-controls="swiper-wrapper-d9a1b88b27852062"><i
            ...
            <div class="container">
                ...
                <div class="swiper-hover-arrow position-relative">
                    <div class="swiper swiper-container swiper-initialized swiper-horizontal swiper-pointer-events"
                        ...
                        <div class="swiper-wrapper" id="swiper-wrapper-6c4eccf3d477549b" aria-live="off"
                             style="transform: translate3d(-1218px, 0px, 0px); transition-duration: 0ms;">
                            <div class="swiper-slide swiper-slide-duplicate" style="width: 173px; margin-right: 30px;"
                                 role="group" aria-label="7 / 8" data-swiper-slide-index="6">
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-1.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-slide swiper-slide-duplicate" style="width: 173px; margin-right: 30px;"
                                ...
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-2.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="catargory-info">
                            ...
                            <!-- catargory Card -->
                            <div class="swiper-slide" style="width: 173px; margin-right: 30px;" role="group"
                            ...
                            <div class="swiper-slide" style="width: 173px; margin-right: 30px;" role="group"
                                ...
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-3.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="catargory-info">
                            ...
                            <!-- catargory Card -->
                            <div class="swiper-slide swiper-slide-prev" style="width: 173px; margin-right: 30px;"
                                 role="group" aria-label="4 / 8" data-swiper-slide-index="3">
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-4.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="catargory-info">
                            ...
                            <!-- catargory Card -->
                            <div class="swiper-slide swiper-slide-active" style="width: 173px; margin-right: 30px;"
                                 role="group" aria-label="5 / 8" data-swiper-slide-index="4">
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-5.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="catargory-info">
                            ...
                            <!-- catargory Card -->
                            <div class="swiper-slide swiper-slide-next" style="width: 173px; margin-right: 30px;"
                                 role="group" aria-label="6 / 8" data-swiper-slide-index="5">
                                <div class="catargory-card-01">
                                    <div class="catargory-media">
                                        <a href="#">
                                            <img src="../resources/gallery/shopy/assets/img/catagory-6.jpg" title=""
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="catargory-info">
                        ...
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                    <div class="swiper-arrow-style-02 swiper-next swiper-next-03" tabindex="0" role="button"
                         aria-label="Next slide" aria-controls="swiper-wrapper-6c4eccf3d477549b"><i
                            class="bi bi-chevron-right"></i></div>
                    <div class="swiper-arrow-style-02 swiper-prev swiper-prev-03" tabindex="0" role="button"
                         aria-label="Previous slide" aria-controls="swiper-wrapper-6c4eccf3d477549b"><i
                            class="bi bi-chevron-left"></i></div>
                </div>
            </div>
        </section>
        ...
        <%--        <section>--%>
        <%--            <div class="container">--%>
        <%--                <div class="bg-cover bg-center bg-no-repeat px-4 py-10" style="background-image: url(../assets/img/shop-banner-8.jpg);">--%>
        ...
        <%--                            }--%>
        <%--                        }">--%>
        <%--                        <div class="swiper-wrapper" id="swiper-wrapper-c3314663ffb102b46" aria-live="off" style="transform: translate3d(-1600px, 0px, 0px); transition-duration: 0ms;">--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide" style="width: 376px; margin-right: 24px;" role="group" aria-label="1 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        ...
        <%--                            </div>--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide" style="width: 376px; margin-right: 24px;" role="group" aria-label="2 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        <%--                                        <div class="position-absolute top-0 end-0 p-3 z-index-1">--%>
        <%--                                            <span class="bg-dark text-white d-inline-flex px-3 fs-sm py-2">18 FEB</span>--%>
        ...
        <%--                            </div>--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide" style="width: 376px; margin-right: 24px;" role="group" aria-label="3 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        <%--                                        <div class="position-absolute top-0 end-0 p-3 z-index-1">--%>
        <%--                                            <span class="bg-dark text-white d-inline-flex px-3 fs-sm py-2">18 FEB</span>--%>
        ...
        <%--                            </div>--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide swiper-slide-prev" style="width: 376px; margin-right: 24px;" role="group" aria-label="4 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        <%--                                        <div class="position-absolute top-0 end-0 p-3 z-index-1">--%>
        <%--                                            <span class="bg-dark text-white d-inline-flex px-3 fs-sm py-2">18 FEB</span>--%>
        ...
        <%--                            </div>--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide swiper-slide-active" style="width: 376px; margin-right: 24px;" role="group" aria-label="5 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        <%--                                        <div class="position-absolute top-0 end-0 p-3 z-index-1">--%>
        <%--                                            <span class="bg-dark text-white d-inline-flex px-3 fs-sm py-2">18 FEB</span>--%>
        ...
        <%--                            </div>--%>
        <%--                            <!-- Blog Card -->--%>
        <%--                            <div class="swiper-slide swiper-slide-next" style="width: 376px; margin-right: 24px;" role="group" aria-label="6 / 6">--%>
        <%--                                <div class="hover-scale">--%>
        <%--                                    <div class="hover-scale-in position-relative">--%>
        <%--                                        <div class="position-absolute top-0 end-0 p-3 z-index-1">--%>
        <%--                                            <span class="bg-dark text-white d-inline-flex px-3 fs-sm py-2">18 FEB</span>--%>
        ...
        <%--                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>--%>
        <%--                    <div class="swiper-arrow-style-02 swiper-next swiper-next-04" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-c3314663ffb102b46" aria-disabled="false"><i class="bi bi-chevron-right"></i> </div>--%>
        <%--                    <div class="swiper-arrow-style-02 swiper-prev swiper-prev-04" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-c3314663ffb102b46" aria-disabled="false"><i class="bi bi-chevron-left"></i></div>--%>
        <%--                </div>--%>
        <%--            </div>--%>
        <%--        </section>--%>
        <!-- End section -->
    ...
    <%--                    <div class="pb-3">--%>
    <%--                        <img src="../resources/gallery/shopy/assets/img/logo-light.svg" title="" alt="">--%>
    <%--                    </div>--%>
    <%--                    <address class="dark-link mb-4">--%>
    <%--                        <p class="mb-2 text-white opacity-7">301 The Greenhouse London,<br> E2 8DY UK</p>--%>
    <%--                        <p class="mb-2"><a class="border-bottom border-secondary text-white" href="mailto:support@domain.com">support@domain.com</a></p>--%>
    <%--                        <p class="mb-2"><a class="border-bottom border-secondary text-white" href="tel:820-885-3321">820-885-3321</a></p>--%>
    <%--                    </address>--%>
    <%--                    <ul class="list-inline mb-0">--%>
    <%--                        <li class="list-inline-item">--%>
    <%--                            <a class="btn btn-sm btn-light-soft avatar-xs d-inline-flex align-items-center justify-content-center p-0" href="#">--%>
    ...
    <%--                        </li>--%>
    <%--                        <li>--%>
    <%--                            <a href="#" class="text-white">Gift card conditions</a>--%>
    <%--                        </li>--%>
    <%--                        <li>--%>
    ...
    <%--                        </li>--%>
    <%--                        <li>--%>
    <%--                            <a href="#" class="text-white">Denim</a>--%>
    <%--                        </li>--%>
    <%--                    </ul>--%>
    <%--                </div>--%>
    <%--            </div>--%>
    ...
    <%--                        <p class="m-0 text-white fw-400 opacity-7 small">© 2022 copyright by <a target="_blank" href="https://www.uiocean.com/" class="text-reset">uiocean.com - pxdraft</a></p>--%>
    <%--                    </div>--%>
    <%--                    <div class="col-md-6 text-center text-md-end py-1">--%>
    <%--                        <img src="../resources/gallery/shopy/assets/img/payments.png" title="" alt="">--%>
    <%--                    </div>--%>
    <%--                </div>--%>
    <%--            </div>--%>
    <%--        </div>--%>
