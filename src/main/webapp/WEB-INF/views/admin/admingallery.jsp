        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    >
                        <th class="px-4 py-3">갤러리 고유 번호</th>
                    ...
                    >
                    <%-- 갤러리 글 --%>
                    <c:forEach items="${galleryDTOList}" var="gallery">
                        <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        <p class="font-semibold"><a
                                                href="../gallery/single?g_no=${gallery.g_NO}"> ${gallery.g_NO}</a></p>
                            ...
                            <td class="px-4 py-3 text-sm">
                                #${gallery.MT_NAME}/${gallery.g_TAG1}
                            </td>
                            <td class="px-4 py-3 text-xs">
                                <c:if test="${gallery.g_STATUS==0}">
                        <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                             정상 노출
                        </span>
                                </c:if>
                                <c:if test="${gallery.g_STATUS==1}">
                                ...
                                <c:if test="${gallery.g_STATUS==2}">
                        <span class="px-2 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:text-white dark:bg-orange-600">
                             유저 요청 숨김(유저 삭제)
                        </span>
                                </c:if>
                                <c:if test="${gallery.g_STATUS==3}">
                        <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700">
                            ...
                            <td class="px-4 py-3 text-sm">
                                    ${gallery.g_REG}/${gallery.g_EDIT eq gallery.g_REG ? '-' : gallery.g_EDIT}
                            </td>
                            <td class="px-4 py-3 text-sm">
                                <input name="checkOne" type="checkbox" value="${gallery.g_NO}">
                            </td>
                        </tr>
            ...
            <form action="/admin/gallery?pageNum=1&listQty=10" method="get">
